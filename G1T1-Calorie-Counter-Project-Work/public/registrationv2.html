...
<body>
    ...
    <script type="module">
        ...
        import { getFirestore, doc, setDoc, collection, query, where, getDocs } from "https://www.gstatic.com/firebasejs/10.12.3/firebase-firestore.js";
            ...
            if (!querySnapshot.empty) {
                ...
                try {
                    ...
                    const userData = {
                        ...
                        carbohydrates,  // NutritionAPI fields
                        protein,
                        fat,
                        fiber,
                        bmi,
