    ...
    const registerForm = document.getElementById('typing-form');

    registerForm.addEventListener('submit', async (e) => {
        e.preventDefault();

        let foodInput = new Date().toISOString().split('T')[0] + '|' + document.getElementById('typing-input').value + '|' + document.getElementById('text').value;
